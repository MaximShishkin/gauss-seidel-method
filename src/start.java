...
class myprogramm extends JFrame {
	...
	public myprogramm() {
        ...
        try {
			myPicture = ImageIO.read(new File("D:\\Files\\MakShish\\Desktop\\ннадо\\ВКР магистра\\мой дисер\\остальное\\остальное\\image3.PNG"));
		} catch (IOException e) {
	...
	public static String MMain(double V,double lymbda,double mu) {
		// lymbda = 5;
		// mu = 1;
		// V = 10;
		...
		dif=lymbda-lymbda*Pс-m*mu;
		rezultat=rezultat+"Доля потерянных заявок: "+"\n";
		rezultat=rezultat+""+Pс+"\n";
		rezultat=rezultat+"Среднее число занятых операторов: "+"\n";
		rezultat=rezultat+""+m+"\n";
		
		System.out.println("Pc="+Pс);
